...
def test_validate_pip_version(mocker):
    ...
    mocker.patch("iso_freeze.iso_freeze.run_pip", return_value=mocked_pip_version_output_1)
    ...
    mocker.patch("iso_freeze.iso_freeze.run_pip", return_value=mocked_pip_version_output_2)
    ...
    mocker.patch("iso_freeze.iso_freeze.run_pip", return_value=mocked_pip_version_output_3)
    assert iso_freeze.validate_pip_version(Path("python3")) == True
    mocked_pip_version_output_4 = "pip 20.1.3 from /funny/path/pip (python 3.8)"
    mocker.patch("iso_freeze.iso_freeze.run_pip", return_value=mocked_pip_version_output_4)
    assert iso_freeze.validate_pip_version(Path("python3")) == False
    mocked_pip_version_output_5 = "pip 34.2.9 from /funny/path/pip (python 3.15)"
    mocker.patch("iso_freeze.iso_freeze.run_pip", return_value=mocked_pip_version_output_5)
    assert iso_freeze.validate_pip_version(Path("python3")) == True
